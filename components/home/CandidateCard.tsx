...
import { Play, Star, Trophy, Radio, Eye, X, Info, Sparkles } from 'lucide-react';
...
export default function CandidateCard({
  ...
  return (
    <div
      className={`group relative bg-zinc-950 text-white rounded-xl overflow-hidden transition-all duration-300 border border-white/10 aspect-[3/4] ${
      ...
      >
        ...
        {selectedVideo === candidate.id && isPlaying ? (
          ...
          <>
            ...
            {/* Gradient pour bien voir les textes en bas */}
            <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-10" />
        ...
        {/* Back Face - Bio (CORRIGÉ) */}
        <div 
          className="absolute inset-0 bg-zinc-950 p-6 flex flex-col" 
