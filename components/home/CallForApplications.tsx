...
export default function CallForApplications({ competitionStarted = false }: CallForApplicationsProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-zinc-950 to-[#090909] border border-zinc-900/60 rounded-[1.5rem] sm:rounded-[2rem] px-4 sm:px-16 py-10 sm:py-24 shadow-2xl text-center flex flex-col items-center">
        ...
        <div className="relative z-10 max-w-full sm:max-w-4xl space-y-5 sm:space-y-8 flex flex-col items-center w-full">
          ...
          <h2 className="font-title text-2xl sm:text-4xl lg:text-6xl font-black tracking-tight leading-[1.15] sm:leading-[1.1] text-white uppercase max-w-full sm:max-w-4xl px-2">
          ...
          {/* Description Épurée */}
          <p className="font-sans text-[11px] sm:text-xs lg:text-sm leading-relaxed sm:leading-7 text-zinc-400 max-w-full sm:max-w-xl font-normal tracking-wide px-4">
          ...
          <div className="pt-2 max-w-full sm:max-w-2xl px-2">
          ...
          <div className="pt-4 flex justify-center items-center w-full px-4 sm:px-0">
            <Link
