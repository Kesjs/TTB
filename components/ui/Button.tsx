...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      primary: 'bg-[#e5c47f] text-black hover:bg-[#d4b36e] focus:ring-[#e5c47f] shadow-md',
      secondary: 'bg-zinc-800 text-white hover:bg-zinc-700 focus:ring-zinc-600',
      outline: 'border-2 border-[#e5c47f] text-[#e5c47f] hover:bg-[#e5c47f] hover:text-black focus:ring-[#e5c47f]',
      ghost: 'text-zinc-300 hover:bg-zinc-800 hover:text-white focus:ring-zinc-600',
